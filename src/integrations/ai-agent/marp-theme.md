---
meta-description: The skinny framework for creating slide deck from Markdown
meta-viewport: width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0
title: Marpit: The skinny framework for creating slide deck from Markdown
---


--- Docsify markdown content ---
